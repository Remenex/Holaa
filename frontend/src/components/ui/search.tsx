...
export function Search({
  ...
  return (
    <form
      className={cn(
        "w-full relative max-w-xl h-12 rounded-full overflow-hidden shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),_0px_1px_0px_0px_rgba(25,28,33,0.02),_0px_0px_0px_1px_rgba(25,28,33,0.08)] transition duration-200",
        light ? "bg-gray-50" : "bg-zinc-800",
        center ? "mx-auto" : ""
      )}
    ...
    >
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-sm sm:text-base z-50 border-nonetext-white bg-transparent text-white h-full rounded-full focus:outline-none focus:ring-0 pl-2 sm:pl-6 pr-20",
