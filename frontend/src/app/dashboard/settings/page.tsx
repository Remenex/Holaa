    ...
    <div className="mx-auto max-w-270">
      <div className="w-full flex items-center justify-between pb-8">
        ...
        <div className="flex items-center">
          ...
          <p className="text-2xl text-blue-600">Podesavanja</p>
        </div>
      </div>
      <div className="grid grid-cols-5 gap-8">
        <div className="col-span-5 xl:col-span-3">
          <div className="rounded-sm border border-gray-600 shadow-default dashboard-main">
            <div className="border-b px-7 py-4 border-gray-600">
              <h3 className="font-medium text-white">Licne Informacije</h3>
            </div>
            <div className="p-7">
              <form action="#">
                ...
                <div className="mb-5">
                  <SettingsInput
                    label="Email adresa"
                    icon="mail"
                    placeholder="idjordje63@gmail.com"
        ...
        <div className="col-span-5 xl:col-span-2">
          <div className="rounded-sm border border-stroke dashboard-main shadow-default border-gray-600">
            <div className="border-b border-stroke px-7 py-4 border-gray-600">
              <h3 className="font-medium text-white">Vasa Profilna Slika</h3>
            </div>
            <div className="p-7">
              <form action="#">
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <div>
                    <span className="mb-2 text-white text-lg">
                      Upravljaj svojom slikom
                    </span>
                    <span className="flex gap-2.5">
                      <button className="text-sm gray-text hover:text-white">
                        Obrisi
                      </button>
                      <button className="text-sm gray-text hover:text-white">
                        Azuriraj
